...
static struct key keys_full[], keys_full_wide[], keys_special[], keys_specialpad[], keys_simple[],
  ...
  keys_compose_cyr_k[], keys_dialer[], keys_index[], keys_numberonly[];
...
static struct layout layouts[NumLayouts] = {
  ...
  [NumberOnly] = {keys_numberonly,"latin","digit", false},
};
...
static struct key keys_numberonly[] = {
  {"1", "1", 1.0, Code, KEY_1},
  {"2", "2", 1.0, Code, KEY_2},
  {"3", "3", 1.0, Code, KEY_3},
  {"", "", 0.0, EndRow},
