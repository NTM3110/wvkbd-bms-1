...
static struct key keys_landscape[] = {
  ...
  {"▼", "▼", 1.0, Hide, .scheme = 1},
  {"?123", "?123", 1.5, Layout, 0, &layouts[LandscapeSpecial], .scheme = 1},
  {",", "'", 1.0, Code, KEY_COMMA, &layouts[ComposeMath]},
...
static struct key keys_landscape_special[] = {
  ...
  {"Abc", "Abc", 1.5, Layout, 0, &layouts[Landscape], .scheme = 1},
  {"<", "<", 1.0, Code, KEY_COMMA, 0, Shift},
  {">", ">", 1.0, Code, KEY_DOT, 0, Shift},
  {"", "Space", 2.0, Code, KEY_SPACE},
  {"", "", 1.75, Pad, .scheme = 1},
  {"0", "0", 2.0, Code, KEY_0},
  {".", ".", 1.0, Code, KEY_DOT},
  {"▼", "▼", 1.5, Hide, .scheme = 1},
